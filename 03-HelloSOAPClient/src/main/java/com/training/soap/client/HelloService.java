 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://soap.training.com/", wsdlLocation = "http://localhost:8080/02-HelloSOAP/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://soap.training.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/02-HelloSOAP/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://soap.training.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.training.com/", "HelloPort"), Hello.class, features);
    }
